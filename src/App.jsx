...
const CAT_PALETTE = ['#16a34a','#2563eb','#9333ea','#db2777','#ea580c','#0891b2','#65a30d','#854d0e','#475569','#b45309', '#dc2626', '#eab308', '#171717']
...
logo: { 
 ...
 nav: {
  ...
  cardBody:     {padding:'13px 15px 11px', flex: 1, display: 'flex', flexDirection: 'column'},
  ...
  cardFooter:   {display:'flex',alignItems:'center',justifyContent:'space-between',gap:8, marginTop: 'auto'},
